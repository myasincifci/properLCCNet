...
class LCCNet(nn.Module):
    ...
    def correlate(self, input1, input2):
        ...
        # print(input2.size())
        # print()
        out_corr = self.corr(input1, input2)
    ...
    def forward(self, rgb, lidar1, lidar2):
        H, W = rgb.shape[2:4]
        ...
        if self.pretrained_encoder:
            ...
            # lidar_image
            x2 = self.conv1_lidar(lidar_comb)
        ...
        if self.use_feat_from > 1:
            ...
            corr5 = self.correlate(c15, warp5)
        ...
        if self.use_feat_from > 2:
            ...
            corr4 = self.correlate(c14, warp4)
        ...
        batch_size = transl.size(0)
        batch_size = batch_size // 2

        # transl1 = transl[:batch_size]
        # transl2 = transl[batch_size:]
        ...
        # return transl1, rot1, transl2, rot2
        return transl, rot
